...
you have any questions or feedback, please do not hesitate to contact us. We wish you the best of luck and hope to see you at the tables soon! \n";
std::cout << "Sincerely, \n";
...
void makePlayer (std::string &playerName, int &age, char &gender) {
    std::cout << "First you need to create a player account. \n";
    std::cout << "What is your name? \n";
    std::cin >> playerName;
    std::cout << "What is your age? \n";
    std::cin >> age;
    std::cout << "What is yout gender (write m or f)?  \n";
    std::cin >> gender;
    
    std::cout << "You are " << playerName << ". " << "You are " << age << " years old. \n";
